...
Be sure to select the correct cluster btw. - although once the system is in maintenance mode you can change it. I had one try to activate in the wrong cluster and well, it wasn't pretty (wrong CPU types etc).
